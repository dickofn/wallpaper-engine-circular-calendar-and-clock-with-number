...
$(function () {
  ...
  function clockRotation() {
    setInterval(function () {
      ...
      $(".clock-number").removeClass("active");
      switch (hours) {
        case 0:
          $(".clock-number.num12").addClass("active");
          break;
        case 12:
          $(".clock-number.num12").addClass("active");
          break;
        case 24:
          ...
          break;
        case 1:
          $(".clock-number.num1").addClass("active");
          break;
        case 13:
          $(".clock-number.num1").addClass("active");
          break;
        case 2:
          $(".clock-number.num2").addClass("active");
          break;
        case 14:
          $(".clock-number.num2").addClass("active");
          break;
        case 3:
          $(".clock-number.num3").addClass("active");
          break;
        case 15:
          $(".clock-number.num3").addClass("active");
          break;
        case 4:
          $(".clock-number.num4").addClass("active");
          break;
        case 16:
          $(".clock-number.num4").addClass("active");
          break;
        case 5:
          $(".clock-number.num5").addClass("active");
          break;
        case 17:
          $(".clock-number.num5").addClass("active");
          break;
        case 6:
          $(".clock-number.num6").addClass("active");
          break;
        case 18:
          $(".clock-number.num6").addClass("active");
          break;
        case 7:
          $(".clock-number.num7").addClass("active");
          break;
        case 19:
          $(".clock-number.num7").addClass("active");
          break;
        case 8:
          $(".clock-number.num8").addClass("active");
          break;
        case 20:
          $(".clock-number.num8").addClass("active");
          break;
        case 9:
          $(".clock-number.num9").addClass("active");
          break;
        case 21:
          $(".clock-number.num9").addClass("active");
          break;
        case 10:
          $(".clock-number.num10").addClass("active");
          break;
        case 22:
          $(".clock-number.num10").addClass("active");
          break;
        case 11:
          $(".clock-number.num11").addClass("active");
          break;
        case 23:
          $(".clock-number.num11").addClass("active");
          break;
  ...
  function init() {
    ...
    $(".clock-name-preview").fadeTo(10, 1);
    ...
    setTimeout(function () {
      $(".clock-name-preview").fadeTo(500, 0);
      $(".center-preview").fadeTo(500, 0);
      $(".head").fadeTo(500, 0);
      $(".torso").fadeTo(500, 0);
      $(".clock-number").fadeTo(500, 1);
